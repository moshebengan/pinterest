        ...
        <div className="">
          <div className="editingOption">
            ...
            <div className="orientations">
              <div className={`orientation ${canvasOptions.orietation === 'portrait' ? 'selected' : ''}`}>P</div>
              <div className={`orientation ${canvasOptions.orietation === 'landscape' ? 'selected' : ''}`}>L</div>
            </div>
          </div>
          <div className="editingOption">
            <span>Size</span>
            <div className="sizes">
              <div className={`size ${canvasOptions.size === 'original' ? 'selected' : ''}`}>Original</div>
              {canvasOptions.orietation === "portrait" ? (
                <>
                  {portraitSizes.map((size) => (
                    <div className={`size ${canvasOptions.size === size.name ? 'selected' : ''}`} key={size.name}>
                      {size.name}
                    </div>
                  ))}
                </>
