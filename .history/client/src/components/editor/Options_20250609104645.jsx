...
const Options = ({previewImg}) => {
  ...
  const originalOrientation = previewImg.width < previewImg.height ? "landscape" : "portrait";
  console.log('width', previewImg.width)
  console.log('height', previewImg.height)
  console.log(previewImg.height - previewImg.width)
  console.log(previewImg.width - previewImg.height)
  ...
  const handleSizeClick = (size) => {
    ...
    setCanvasOptions({ ...canvasOptions, size: size === "original" ? "original" : size.name, height: newHeight });
  };
  ...
  const handleOrientationClick = (orientation) => {
    ...
    setCanvasOptions({ ...canvasOptions, orientation: orientation, size: "original", height: newHeight });
  };
        ...
        <div className="">
          ...
          <div className="editingOption">
            ...
            <div className="sizes">
              ...
              {canvasOptions.orietation === "portrait" ? (
                <>
